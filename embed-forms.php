 ...
 * Description: Build forms in WordPress and embed them on any website with one script tag. Payments through USAePay (with the USAePay Payments plugin) or Stripe, per form.
